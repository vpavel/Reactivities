        ...
        {activity.isHost ? (
          <>
            <Button
              ...
              loading={loading}
            />
            <Button disabled={activity.isCancelled} to={`/manage/${activity.id}`} color="orange" floated="right">
              Manage Event
            </Button>
          </>
        ) : activity.isGoing ? (
          ...
          <Button disabled={activity.isCancelled} color="teal" loading={loading} onClick={updateAttendance}>
            Join Activity
          </Button>
        )}
      </Segment>
